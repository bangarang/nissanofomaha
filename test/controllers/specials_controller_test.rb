...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { description: @special.description, image: @special.image, name: @special.name, price: @special.price }
    end
  ...
  test "should update special" do
    patch :update, id: @special, special: { description: @special.description, image: @special.image, name: @special.name, price: @special.price }
    assert_redirected_to special_path(assigns(:special))
  end
